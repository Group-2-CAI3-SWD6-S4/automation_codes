...
public class LoginPage {
    ...
    private By emailExistsErrorMessage =  By.xpath("//p[contains(text(),'Email Address already exist!')]");
    ...
    public String getNewUserSignupText(){
        String message = driver.findElement(newUserSignupText).getText();
        return message;
    }
    public String getEmailExistsErrorMessage(){
        String message = driver.findElement(emailExistsErrorMessage).getText();
        return message;
    }
}
